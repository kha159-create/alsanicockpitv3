...
import type { DateFilter, FilterableData } from '../types.js';
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-200">
      ...
      <div className="flex items-center gap-2 flex-1 min-w-[150px]">
        ...
        <select value={dateFilter.day} onChange={handleDayChange} className="input w-full" disabled={dateFilter.month === 'all' || dateFilter.year === 'all'}>
