...
import type { CommissionStoreData, EmployeeSummary, Store, DateFilter, AreaStoreFilterState, FilterableData, UserProfile } from '../types.js';
...
const CommissionsPage: React.FC<CommissionsPageProps> = ({ 
    ...
    // Safe fallback for undefined or empty commissionData
    const safeCommissionData = commissionData || [];
    const [openStore, setOpenStore] = useState<string | null>(safeCommissionData.length > 0 ? safeCommissionData[0].name : null);
