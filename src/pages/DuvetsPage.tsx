...
import type { DuvetSummary, Store, DateFilter, AreaStoreFilterState, FilterableData, UserProfile } from '../types.js';
...
const DuvetsPage: React.FC<DuvetsPageProps> = ({ 
    ...
    const data: DuvetRow[] = useMemo(() => 
        // FIX: Explicitly type 'd' to resolve type inference issues with Object.values.
