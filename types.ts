// FIX: Switched to Firebase compat library to resolve module import errors.
import firebase from 'firebase/compat/app';
import 'firebase/compat/auth';

// FIX: Corrected the User type to reference firebase.User instead of firebase.auth.User.
...
export interface SalesTransaction extends BaseDocument {
  'Bill Dt.': firebase.firestore.Timestamp;
  'Outlet Name': string;
